/* Shadow copy of thirdparty/FFmpeg/config_linux_aarch64.h with CONFIG_WMAV2_DECODER
 * forced on (upstream FFmpeg submodule config wrongly disables it on this
 * platform only). Force-included ahead of the real header so its include
 * guard (FFMPEG_CONFIG_H) suppresses the broken one. Delete this file and
 * the corresponding CMake wiring once upstream fixes the submodule.
 */
/* Automatically generated by configure - do not modify! */
#ifndef FFMPEG_CONFIG_H
#define FFMPEG_CONFIG_H
#define FFMPEG_CONFIGURATION "--enable-cross-compile --arch=aarch64 --target-os=linux --disable-everything --disable-programs --disable-all --disable-autodetect --enable-avcodec --enable-avutil --enable-decoder=xmaframes"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2021
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "Ubuntu clang version 18.1.3"
