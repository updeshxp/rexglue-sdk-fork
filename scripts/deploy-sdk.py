...
# warning; override with one or more --project NAME flags.
PROJECTS = ["ReKameo", "EternalSonataReprise", "NocturneRecomp"]
...
parser.add_argument("--config", choices=CONFIGS, default="Release",
...
parser.add_argument("--project", action="append", metavar="NAME",
                    help="Target project dir to deploy into (repeatable; "
                         f"default: {', '.join(PROJECTS)})")
